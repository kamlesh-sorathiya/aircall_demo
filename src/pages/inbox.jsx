...
// const CallItemCard = React.lazy(() => import('../components/CallItemCard.jsx'));
...
const inbox = () => {
  ...
  const [loading, setLoading] = useState(true);
   ...
   useEffect(() => {
    ...
    .then((apiData) => {
        setLoading(false);
        setData(apiData.filter(data => data.direction === "inbound"));
        console.log(`Data added to data`,apiData)
    })
    .catch((err) => {
